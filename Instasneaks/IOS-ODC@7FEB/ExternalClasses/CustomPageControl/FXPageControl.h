...
@property (nonatomic, assign) IBInspectable int dotSize;
...
@property (nonatomic, assign) IBInspectable int selectedDotSize;
...
@property (nonatomic, assign) IBInspectable int dotSpacing;
