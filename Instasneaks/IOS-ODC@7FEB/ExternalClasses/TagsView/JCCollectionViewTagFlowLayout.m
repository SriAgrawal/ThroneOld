...
- (CGFloat)calculateContentHeight:(NSArray *)tags {
    ...
    for (NSInteger i = 0; i < tags.count; i++) {
        ...
        CGRect frame = [tags[i] boundingRectWithSize:maxSize options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: [AppUtility sofiaProLightFontWithSize:12]} context:nil];
        
        CGSize itemSize = CGSizeMake(frame.size.width, self.itemSize.height);
