...
@property (nonatomic, assign) IBInspectable BOOL isForCategory; // default: NO

@property (nonatomic, assign) IBInspectable CGFloat tagCornerRadius; // default: 10

@property (nonatomic, strong) UIFont *tagTextLightFont; // default: [UIFont systemFontOfSize:14.0f]
@property (nonatomic, strong) UIFont *tagTextBoldFont; // default: [UIFont systemFontOfSize:14.0f]
