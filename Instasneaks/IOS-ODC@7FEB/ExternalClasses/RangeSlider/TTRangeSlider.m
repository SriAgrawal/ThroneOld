...
- (void)initialiseControl {
    ...
    self.sliderLineBetweenHandles.backgroundColor = [UIColor blackColor].CGColor;
    ...
    self.leftHandle.borderWidth = 1;
    self.leftHandle.borderColor = [UIColor colorWithRed:240.0/255.0 green:240.0/255.0 blue:240.0/255.0 alpha:1.0].CGColor;
    self.leftHandle.shadowColor = [UIColor colorWithRed:240.0/255.0 green:240.0/255.0 blue:240.0/255.0 alpha:1.0].CGColor;
    self.leftHandle.shadowOpacity = 1.0;
    ...
    self.rightHandle.borderWidth = 1;
    self.rightHandle.borderColor = [UIColor colorWithRed:240.0/255.0 green:240.0/255.0 blue:240.0/255.0 alpha:1.0].CGColor;
    [self.layer addSublayer:self.rightHandle];
    self.rightHandle.shadowOpacity = 1.0;
    self.rightHandle.shadowColor = [UIColor colorWithRed:240.0/255.0 green:240.0/255.0 blue:240.0/255.0 alpha:1.0].CGColor;
    ...
    self.minLabel.frame = CGRectMake(0, 0, 85, TEXT_HEIGHT);
    self.minLabel.contentsScale = [UIScreen mainScreen].scale;
    self.minLabel.contentsScale = [UIScreen mainScreen].scale;
    if (self.minLabelColour == nil){
        self.minLabel.foregroundColor = [UIColor darkGrayColor].CGColor;
    } else {
        self.minLabel.foregroundColor = [UIColor darkGrayColor].CGColor;
    }
    self.minLabelFont = [AppUtility sofiaProLightFontWithSize:kLabelsFontSize];
    ...
    self.maxLabel.frame = CGRectMake(0, 0, 100, TEXT_HEIGHT);
    self.maxLabel.contentsScale = [UIScreen mainScreen].scale;
    if (self.maxLabelColour == nil){
        self.maxLabel.foregroundColor = [UIColor blackColor].CGColor;
    } else {
        self.maxLabel.foregroundColor = [UIColor blackColor].CGColor;
    }
    self.maxLabelFont = [AppUtility sofiaProLightFontWithSize:kLabelsFontSize];
...
- (void)updateLabelValues {
    ...
    self.minLabel.string = [NSString stringWithFormat:@"$%0.f", self.selectedMinimum];
    self.maxLabel.string = (self.selectedMaximum>999) ? @"$1,000+" : [NSString stringWithFormat:@"$%0.f", self.selectedMaximum];
...
- (NSNumberFormatter *)decimalNumberFormatter {
    if (!_decimalNumberFormatter){
       ...
       // _decimalNumberFormatter.numberStyle = kCFNumberFormatterNoStyle;
